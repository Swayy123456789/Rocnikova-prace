  ...
  return (
    <>
      ...
      <form>
        ...
        <input type="text" name="type" required placeholder="Enter type" onChange={handleChange}/>
        <input type="text" name="strapMaterial" required placeholder="Enter strap material" onChange={handleChange}/>
        <input type="text" name="material" required placeholder="Enter material" onChange={handleChange}/>
